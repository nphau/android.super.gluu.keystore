...
- (SCLAlertViewResponder *)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    for (SCLTextView *textField in _inputs)
    {
        textField.layer.borderColor = [UIColor lightGrayColor].CGColor;//viewColor.CGColor;
    }
...
- (void)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle style:(SCLAlertViewStyle)style closeButtonTitle:(NSString *)closeButtonTitle duration:(NSTimeInterval)duration{
    [self showTitle:vc image:image color:color title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:style];
}
...
- (SCLAlertViewBuilder *(^) (NSString *titleFontFamily, CGFloat size, UIColor* color))setTitleFontFamily {
    if (!_setTitleFontFamily) {
        __weak typeof(self) weakSelf = self;
        _setTitleFontFamily = ^(NSString *titleFontFamily, CGFloat size, UIColor* color) {
            [weakSelf.alertView setTitleFontFamily:titleFontFamily withSize:size withColor:color];
            return weakSelf;
        };
    }
