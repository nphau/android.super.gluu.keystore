...
class PurchaseHandler: NSObject {
    ...
    func showAlert(title: String, message: String) {
        ...
        _ = alert.showCustom(title, subTitle: message, color: UIColor.Gluu.green, icon: UIImage(named: "gluuIconAlert.png")!, closeButtonTitle: "Ok", duration: 3.0)
    }
    ...
    func purchaseSubscription(completion: @escaping (Bool) -> Void ) {
        ...
        SwiftyStoreKit.purchaseProduct(productId, atomically: true) { result in
            ...
            case .error(let error):
                ...
                case .unknown:                             msg = "Unknown error. Please contact support at transactions@campfire.fm"
            ...
            if let message = msg {
                let alert = SCLAlertView()
                _ = alert.showCustom("Oops!", subTitle: message, color: UIColor.Gluu.green, icon: UIImage(named: "gluuIconAlert.png")!, closeButtonTitle: "Ok", duration: 3.0)
            }
